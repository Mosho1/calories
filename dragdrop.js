...
angular.module("ngDragDrop",[])
    ...
    .directive("uiDraggable", [
        ...
        '$rootScope',
        'dropInfo',
        function ($parse, $rootScope, dropInfo) {
            return function (scope, element, attrs) {
                ...
                element.bind("dragstart", function (e) {
                    ...
                    if (isDragAllowed) {
                        ...
                        dropInfo.source = element.parent()[0];
                ...
                element.bind("dragend", function (e) {
                    ...
                    if (e.dataTransfer && e.dataTransfer.dropEffect !== "none" && dropInfo.source !== dropInfo.target) {
        ...
        function ($parse, $rootScope, dropInfo) {
            return function (scope, element, attr) {
                ...
                function onDrop(e) {
                    ...
                    dropInfo.target = element[0];
                    if (dropInfo.source !== dropInfo.target) {
